...
apt-get update
apt-get install -y libjpeg-dev libpng-dev libavcodec-dev libavformat-dev libswscale-dev libavresample-dev libtbb-dev openexr gfortran libatlas-base-dev libopencv-dev
